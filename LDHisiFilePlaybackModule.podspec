...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    LDHisiFilePlaybackModule 海思回放文件组件: 分支2 azdome_branch2 的个性化开发
                   DESC
  ...
  s.author             = { "Sanchain" => "954598055@qq.com" }
  ...
  s.source       = { :git => "https://github.com/Sanchain/LDHisiFilePlaybackModule.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LDHisiFilePlaybackModule/HisiFilePlaybackModule/*"
